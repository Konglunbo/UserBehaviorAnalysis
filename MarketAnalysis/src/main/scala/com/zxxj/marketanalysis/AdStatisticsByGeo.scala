...
object AdStatisticsByGeo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 读取数据并转换成AdClickEve
    val adEventStream = env.readTextFile("E:\\workspace\\workspace_scala\\UserBehaviorAnalysis\\MarketAnalysis\\src\\main\\resources\\AdClickLog.csv")
      .map(data => {
    ...
    dataStream.getSideOutput(blackListOutputTag).print("blacklist")
